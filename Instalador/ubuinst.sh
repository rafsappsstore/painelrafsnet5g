...
exit;
  ...
  echo -e 'by: RAFS NET 4G' >/usr/lib/telegram
  msg -bar
...
wget  https://raw.githubusercontent.com/rafsappsstore/painelrafsnet5g/main/Instalador/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget  https://raw.githubusercontent.com/rafsappsstore/painelrafsnet5g/main/Instalador/verpweb > /dev/null 2>&1
wget  https://raw.githubusercontent.com/rafsappsstore/painelrafsnet5g/main/Instalador/verweb > /dev/null 2>&1
...
wget  https://raw.githubusercontent.com/rafsappsstore/painelrafsnet5g/main/Instalador/gestorssh.zip > /dev/null 2>&1
...
echo ""
echo -e "RAFS PAINEL WEB" | figlet
echo -e "                              \033[1;31mBy RAFS NET 4G\033[1;36m"
echo ""
chave=$(curl -sSL "https://raw.githubusercontent.com/rafsappsstore/painelrafsnet5g/main/Instalador/chave") &>/dev/null
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37mRAFS NET 4G\033[0m"
echo ""
